...
def main(fxyz, prefix, cutoff):
    ...
    np.savetxt(str(prefix)+'-carbon-bond-life-time.dat', lifetime_counter, fmt='%i')
    ...
    np.savetxt(str(prefix)+'-carbon-bond-remaining-life-time.dat', remaining_lifetime, fmt='%i')
